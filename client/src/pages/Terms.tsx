...
export default function TermsPage() {
    return (
        <main className="w-full h-full flex flex-col gap-4 p-4">
            ...
            <p className="md:text-lg">Welcome to TikSlides. These terms and conditions outline the rules and regulations for the use of our application. By accessing this application, we assume you accept these terms and conditions. Do not continue to use TikSlides if you do not agree to take all of the terms and conditions stated on this page.</p>

            <h2 className="font-bold md:text-xl">1. Definitions</h2>
            <p className="md:text-lg">1.1 "Application" refers to TikSlides.</p>
            <p className="md:text-lg">1.2 "User" refers to anyone who uses, downloads, installs, or accesses the Application.</p>
            <p className="md:text-lg">1.3 "We", "Us", and "Our" refer to the developers and operators of TikSlides.</p>

            <h2 className="font-bold md:text-xl">2. License</h2>
            <p className="md:text-lg">2.1 TikSlides grants you a revocable, non-exclusive, non-transferable, limited license to download, install, and use the Application strictly in accordance with these Terms.</p>
            ...
            <p className="md:text-lg">3.3 When you upload, submit, store, send, or receive content to or through our Application, you give TikSlides (and those we work with) a worldwide license to use, host, store, reproduce, modify, create derivative works, communicate, publish, publicly perform, publicly display, and distribute such content.</p>
            ...
            <p className="md:text-lg">By using TikSlides, you agree to be bound by these Terms and Conditions.</p>
        </main>
    )
}